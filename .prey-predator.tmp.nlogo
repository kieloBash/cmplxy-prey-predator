turtles-own [ energy ]
patches-own [ regrowth-count isCarrotPlot? ]
...
to go
  ...
  [
    ...
    print "Carrot"
    print (count patches with [ pcolor = scale-color orange (10 - 3) -10 20 ])
    stop
  ]
...
to eat-herbs
  ifelse( pcolor = green ) [
    set pcolor brown
    set regrowth-count grass-regrow-ticks
...
to setup-carrots
  let random-patch n-of 4 patches

  ask random-patch [
    ask patches in-radius 2[
      regrow-carrot
      set isCarrotPlot? true
...
to regrow-carrot
  set pcolor scale-color orange (10 - 3) -10 20
end
...
"" ""
PENS
"grass" 1.0 0 -12087248 true "" ""
"carrot" 1.0 0 -817084 true "" ""
...
Polygon -7500403 true true 150 120 105 45 60 120
Polygon -7500403 true true 150 120 195 45 240 120
